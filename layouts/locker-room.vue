<template lang="pug">
.xl-locker-room(:class="isLockerRoomRoot && 'locker-room-root'")
  XTLockerRoomHeader
  client-only: XTLockerRoomBreadcrumbs
  .row
    XTLockerRoomSidebarLeft(:supporting="lockerRoomSupporting || supporting")
    nuxt
</template>
...
import XTLockerRoomSidebarLeft from '~/components/templates/LockerRoom/SidebarLeft.vue'
import XTLockerRoomBreadcrumbs from '~/components/templates/LockerRoom/Breadcrumbs.vue'
...
export default {
  ...
  components: {
    ...
    XTLockerRoomBreadcrumbs,
    XTLockerRoomHeader,
    XTLockerRoomSidebarLeft,
  },
  ...
  methods: {
    ...
    fnReloadLockerRoom: debounce(async function () {
      ...
      try {
        this.setLockerRoomIsLoading(true)
    ...
    async fnGetMyProfileDetails() {
      if (!this.isLoggedIn || this.isLoadingGetSupporting) return

      try {
        this.isLoadingGetSupporting = true
        ...
        this.setLockerRoomIsLoading(false)
        this.isLoadingGetSupporting = false
      }
    },
